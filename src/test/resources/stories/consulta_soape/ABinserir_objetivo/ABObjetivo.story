...
When the user insert the height '1.80'
When the user insert the weight '90'
When the user insert the temperature '42'
...
When the user insert the objective comments 'paciente simpatico'
